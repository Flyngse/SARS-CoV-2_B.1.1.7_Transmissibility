...
ods graphics / reset=index imagename = "WGS_TransmissionRATE_WGS_CT_2" imagefmt=pdf ;
...
proc genmod data = super_shead6 plots=none;
	...
	class 
		...
		/ param=glm;
	model
			transmission_d1 = CT_value_2  / noint  ;
			repeated subject = house_number / type=ind;
			weight weight_d1 ;
run;quit;
data parms_pos ;
...
run;
ods listing gpath = "F:\Projekter\FSEID00004942\FrederikPlesnerLyngse\Household Transmission\WGS\Output" ;
ods graphics / reset=index imagename = "WGS_TransmissionRISK_WGS_CT_2" imagefmt=pdf ;
ods graphics on / attrpriority=none border=off ;
Title ;
proc sgplot data = parms noborder;
	where 18 <= CT <= 38 ;
...
ods listing gpath = "F:\Projekter\FSEID00004942\FrederikPlesnerLyngse\Household Transmission\WGS\Output" ;
ods graphics / reset=index imagename = "WGS_TransmissionRATE_WGS_CT_quartile" imagefmt=pdf ;
ods graphics on / attrpriority=none border=off ;
Title ;
proc sgplot data = parms noborder;
	*where 18 <= CT <= 38 ;
...
ods listing gpath = "F:\Projekter\FSEID00004942\FrederikPlesnerLyngse\Household Transmission\WGS\Output" ;
ods graphics / reset=index imagename = "WGS_TransmissionRISK_WGS_CT_quartile" imagefmt=pdf ;
ods graphics on / attrpriority=none border=off ;
Title ;
proc sgplot data = parms noborder;
	*where 18 <= CT <= 38 ;
